...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [13169888.272982, 2805377.401362, 13171959.944137, 2807349.194516], maxZoom: 20, minZoom: 1
    })
});
...
map.getView().fit([13169888.272982, 2805377.401362, 13171959.944137, 2807349.194516], map.getSize());
